<div class='at-container8'>
    <div class='at-item8'>
        <div class="bg-white flex justify-between items-center shadow-sm mb-3 p-6">
            ...
            <div class="w-1/3">
                <h2 class="text-4xl font-bold uppercase"><?= $phytoInter->getPlante() ?></h2>
                <h3 class="text-4xl font-bold text-orange-500"><?= $effetname ?></h3>
                <h4 class="text-4xl font-light text-green-500"><?= $phytoInter->getPrice() ?> €</h4>
            </div>
            <div>
