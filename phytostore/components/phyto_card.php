<div class='at-container2'>
    <div class='at-item2'>
        <div class="bg-white flex justify-between items-center border rounded shadow-sm mb-6 p-6">
            <img class="w-36" src="<?= $phytoInter->getImage() ?>" alt="image">
            <div class="w-1/3">
                <h2 class="text-4xl uppercase"><?= $phytoInter->getPlante() ?></h2>
                <h3 class="text-2xl font-light text-orange-500 ml-2"><?= $phytoInter->getEffet() ?></h3>
                <h4 class="text-3xl font-light text-green-500 ml-2"><?= $phytoInter->getPrice() ?> €</h4>
            </div>
            <div>
